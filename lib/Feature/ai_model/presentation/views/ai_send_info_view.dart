...
//     final input = Float32List.fromList([18, 79,20, 20.13, 23, 5.8, 139.35]);
...
//                       //   final interpreter = await Interpreter.fromAsset('assets/model/crop_model.tflite');
//                       //   print("Model loaded successfully ✅");
//                       //
...
//                       //
//                       //   // Prepare correct input and output shapes
//                       //   var input = List.filled(52, 0.0).reshape([1, 52]);   // 52 float numbers
//                       //   var output = List.filled(51, 0.0).reshape([1, 51]);  // 51 float numbers
//                       //
